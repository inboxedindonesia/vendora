...
class RegulatoryCompany extends \Opencart\System\Engine\Controller {
    public function index(): void {
        ...
        if (!$this->model_common_tenant->isUserAssignedToCompany($user_id, $company_id) && $this->user->getGroupId() != 1) {
        ...
        $data['company'] = $this->model_common_tenant->getCompany($company_id);
